...
NIX_SSHOPTS="-i $ADMIN_KEY" sudo nixos-rebuild switch --flake .#HALLpass.space --target-host matt@hallpass.space --use-remote-sudo  # Build locally on 2600AD, deploy to VPS
