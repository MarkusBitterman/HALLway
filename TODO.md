...
## 2600AD — DOORway Integration

DOORway is a Nix Home Manager module derived from HyDE (Arch Hyprland). Once stable, it will replace the current minimal Hyprland config.

- [ ] Import DOORway module into `flake.nix` inputs
- [ ] Integrate DOORway into `hosts/2600AD/home/bittermang.nix`
- [ ] Test session stability with greetd/regreet
- [ ] Migrate guest user to DOORway (or subset thereof)
...
- [x] Added XFCE as stable X11 fallback session for debugging DOORway integration
