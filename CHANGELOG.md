...
- **DOORway deduplication** (2600AD): Removed 15 packages from `bittermang.nix` now provided by DOORway module (hyprland, hyprlock, hypridle, hyprpaper, hyprsunset, waybar, rofi, dunst, wlogout, kitty, grim, slurp, satty, cliphist, playerctl, awww)
